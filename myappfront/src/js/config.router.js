...
//------------------------------------------------------------------------------
 ...
 //-----------------------------------------------------------------------------------------
    ...
    [          '$rootScope', '$state', '$stateParams','$location','userInfo',
        function ($rootScope,   $state,   $stateParams,$location,userInfo) {
            ...
            $rootScope.$on('$stateChangeStart',
                function(event, toState, toParams, fromState, fromParams, options){
                    var x=userInfo.isAuthentified();

                    if (toState.authenticate&&!x) {
